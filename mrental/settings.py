"""
Django settings for mrental project.
...
SECRET_KEY = '4a#9cg^7m)i)a%zeanf5j#mmu_w685_w*2(su(r_q-z$09#bno'
...
WSGI_APPLICATION = 'mrental.wsgi.application'
